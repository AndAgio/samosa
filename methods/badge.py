...
class BADGE(ALMethod):
    ...
    def get_grad_features(self):
        ...
        with torch.no_grad():
            ...
            for i, (_, (inputs, labels)) in enumerate(unlabeled_loader):
    ...
    def select(self, **kwargs):
        ...
        selected_indices = self.k_means_plus_centers(X=unlabeled_features, K=self.args.query_batch)
