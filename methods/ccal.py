...
class CCAL(ALMethod):
    ...
    def get_label_i_loader(self):
        ...
        label_i_index = [[] for i in range(self.args.known_class)]
        for i in self.I_index:
            for k in range(self.args.known_class):
    ...
    def select(self, **kwargs):
        ...
        simclr_aug = get_simclr_augmentation(self.args, image_size=(32, 32, 3)).to(self.args.gpu)  # for CIFAR10, 100
